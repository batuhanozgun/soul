...
**Current rejected material target:** PR #13 exact commit `a45b463b083604d3f59d75bdca5ba97d5bc170e6`  
...
Current: **active — fresh separate designer/builder required.**

The prior target `a45b463...` remains historically verified PASS under WP-009 but is not suitable to proceed because WP-010 issued **Requires repair**. No new material target exists until the builder publishes and freezes one.

## Handoff

Exact next responsibility: **fresh separate designer/builder under WP-011**. The builder must derive and publish the bounded repair, leave one exact new target and regression evidence, route it to a fresh separate verifier, and stop without self-verification, self-review, acceptance, or merge.
