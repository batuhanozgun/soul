...
## Current work
- Active: `../04_work/WP-014-PHASE0-MOVING-CANDIDATE-CONVERGENCE-REPAIR.md` — fresh separate bounded designer/builder repair for WP-013 F-AR-005; no repaired exact target exists yet
...
- Parent package: `../04_work/WP-000-DEVELOPMENT-OS.md` — Phase 0 remains unaccepted pending WP-014 repair, fresh verification/re-review, decision/owner/PR gates
...
- `../02_architecture/decisions/ADR-0002-PENDING-INDEPENDENT-RESULT-DISCOVERY.md` — revised/proposed on exact WP-011 repair target `adf067e...`; WP-012 verification PASS, WP-013 adversarial re-review **Requires repair**; remains unaccepted and subject to WP-014 repair
